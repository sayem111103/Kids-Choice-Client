const Banner = () => {
    return (
        <section className="rounded-tl-lg rounded-tr-lg py-24 lg:py-[250px]" style={{backgroundImage: `url(${'https://images.unsplash.com/photo-1526369120040-e88e9e510796?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80'})`, backgroundPosition:'center', backgroundAttachment: 'fixed', backgroundRepeat:'no-repeat', backgroundSize: 'cover', backgroundColor:'rgba(0, 0, 0, 0.5)', backgroundBlendMode:'multiply'}}>
